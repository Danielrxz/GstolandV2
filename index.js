...
if (!fs.existsSync(ownerPath)) fs.writeFileSync(ownerPath, JSON.stringify([["526242262017"]], null, 2));
...
soy un bot en desarrollo que cada día mejora ❤️‍🩹 
espero serles útil y gracias por tenerme en tu grupo usa *.menu* para ver la lista de comandos
        `.trim()
      });
